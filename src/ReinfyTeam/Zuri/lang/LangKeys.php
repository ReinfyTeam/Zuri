...
final class LangKeys {
	...
	public const DEBUG_ASYNC_REASON_MISSING_BATCH_PAYLOAD = "messages.debug.system.async-reason-missing-batch-payload";
	public const DEBUG_ASYNC_REASON_DECODE_BATCH_PAYLOAD = "messages.debug.system.async-reason-decode-batch-payload";
	public const DEBUG_ASYNC_REASON_MISSING_CHECK_CLASS = "messages.debug.system.async-reason-missing-check-class";
	public const DEBUG_ASYNC_REASON_MISSING_BATCH_RESULT = "messages.debug.system.async-reason-missing-batch-result";
	public const DEBUG_ASYNC_REASON_INVALID_BATCH_RESULT = "messages.debug.system.async-reason-invalid-batch-result";
	public const DEBUG_ASYNC_REASON_THREAD_OUTPUT_ERROR = "messages.debug.system.async-reason-thread-output-error";
	public const DEBUG_ASYNC_REASON_INVALID_THREAD_OUTPUT = "messages.debug.system.async-reason-invalid-thread-output";
	public const DEBUG_ASYNC_REASON_INVALID_THREAD_RESULT = "messages.debug.system.async-reason-invalid-thread-result";
	public const DEBUG_ASYNC_REASON_RETRY_ATTEMPT = "messages.debug.system.async-reason-retry-attempt";
	public const DEBUG_ASYNC_FAILED_MERGE_EXCEPTION = "messages.debug.system.async-failed-merge-exception";
	public const DEBUG_ASYNC_DISPATCH_PREVIEW = "messages.debug.system.async-dispatch-preview";
	public const DEBUG_ASYNC_SHUTDOWN = "messages.debug.system.async-shutdown";
	...
	public const STARTUP_VAPM_AUTO_DOWNLOAD_START = "startup.vapm-auto-download-start";
	public const STARTUP_VAPM_AUTO_DOWNLOADED = "startup.vapm-auto-downloaded";
	public const STARTUP_VAPM_AUTO_DOWNLOAD_FAILED = "startup.vapm-auto-download-failed";
	public const STARTUP_VAPM_RESTARTING = "startup.vapm-restarting";
	public const STARTUP_PLUGIN_ENABLED_AUDIT = "startup.plugin-enabled-audit";
	public const STARTUP_PLUGIN_DISABLED_AUDIT = "startup.plugin-disabled-audit";
